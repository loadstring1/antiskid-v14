...
module.name="walkspeed"
module.aliases=table.freeze{"ws"}
module.description="sets your walkspeed to whatever value you want"
...
function module.f(data)
    ...
    handler.notifyChat(data.plr, `Your walkspeed has been set to {tostring(value)}`)
end
